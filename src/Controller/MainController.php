...
class MainController extends AbstractController
{
    ...
    public function __construct(ProductRepository $productRepository,EntityManagerInterface $em, MailerInterface $mailer, string $senderAddress, string $contactAddress)
    {
        $this->em = $em;
        $this->mailer = $mailer;
    ...
    {
        $products = $this->productRepository->findFour();
